...
class Supervisor(StateMachine):
    ...
    def on_stop_cycle(self):
        if self.need_restart_robot_2:
            ...
            print("End of work, give me my paycheck and close the visualisation screen after ending my moves if you "
                  "want to start a new cycle!")
    ...
    def draw_supervisor_graph(self):
        ...
        print(list(nx.nodes_with_selfloops(self.__graph)))
        plt.show()
